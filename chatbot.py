...
class MemoryChatbot:
    ...
    def _build_context_prompt(self, user_input: str) -> str:
        ...
        if context["relevant_memories"] and context["relevant_memories"] != "Không tìm thấy thông tin liên quan trong bộ nhớ.":
        ...
        if context["recent_conversation"]:
            ...
            for msg in context["recent_conversation"][-5:]:  # Chỉ lấy 5 tin nhắn gần nhất
